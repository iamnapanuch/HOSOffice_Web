    ...
    <div class="wrapper">
      <div class="top_navbar br">
            ...
            <div>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="home.php">หน้าหลัก</a>
                  <a class="dropdown-item" href="e_book.php">ระบบสารบรรณ</a>
                  <a class="dropdown-item" href="meeting.php">ระบบจองห้องประชุม</a>
                  <a class="dropdown-item" href="com_repair.php">แจ้งซ่อมคอมพิวเตอร์</a>
                  <a class="dropdown-item" href="manager_user.php">จัดการข้อมูลบุคลากร</a>
        ...
        <div class="d-flex align-items-stretch">
          <nav id="sidebar" style=" background: linear-gradient(#405266, #1A3552);">
            <!-- #79797D  ,#1E1E20  -->
            <div class="custom-menu ">
            </div>
            <div class="img bg-wrap text-center py-4" style=" background: linear-gradient( #405266,#1A3552);">
              <div class="user-logo">
            ...
            <ul class="list-unstyled components mb-5">
              ...
              <li>
                <a href="e_book.php"><span class="fas fa-file mr-3"></span>ระบบงานสารบรรณ</a>
              </li>
              <li>
                <a href="meeting.php"><span class="fas fa-clipboard mr-3"></span>ระบบจองห้องประชุม</a>
              </li>
              <li>
                <a href="com_repair.php"><span class="fas fa-tools mr-3"></span>แจ้งซ่อมคอมพิวเตอร์</a>
              </li>
              <li>
                <a href="manager_user.php"><span class="fas fa-users mr-3"></span>จัดการข้อมูลบุคลากร</a>
              </li>
              <li>
